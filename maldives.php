...
?>
        ...
        <section class="section section-sm section-last bg-default text-left">
            ...
            <button class="button button-primary button-pipaluk" id="contact-button-2" onclick="addBookingTableToDataBase()" type="button" name="sbmt">Book Maldives Tour </button>
        </form>
            </div>
        </section>
        <!-- Page Footer-->
