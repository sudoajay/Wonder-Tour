...
?>
        ...
        <section class="breadcrumbs-custom-inset">
            <div class="breadcrumbs-custom context-dark bg-overlay-60">
                ...
                <div class="box-position" style="background-image: url(images/traveldestinations/10.png);"></div>
            </div>
        </section>
        <!-- Why choose us-->
        <section class="section section-sm section-first bg-default text-md-left">
            <div class="container">
                <div class="row row-50 justify-content-center align-items-xl-center">
                    <div class="col-md-10 col-lg-5 col-xl-6"><img src="images/internatinal360/andaman (6).png" alt="" width="519" height="564" />
                    </div>
                        ...
                        <div class="tabs-custom tabs-horizontal tabs-line" id="tabs-4">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="tabs-4-1">
                                    <p>Wonder Tour is always be prompt to plan your business trip ,Vacation Packages with your family and dear one,Short weekend getway,book your domestic and international tour and make your hotel reservations. </p>
                                    <!-- Linear progress bar-->
                                ...
                                <div class="tab-pane fade" id="tabs-4-2">
                                    ...
                                    <div class="group-md group-middle"><a class="button button-width-xl-230 button-primary button-pipaluk" href="contact-us.php">Get in touch</a><a class="button button-black-outline button-width-xl-230" href="">Read more</a></div>
                                </div>
                                <div class="tab-pane fade" id="tabs-4-3">
                                    ...
                                    <div class="text-center text-sm-left offset-top-30 tab-height">
                                        <ul class="row-16 list-0 list-custom list-marked list-marked-sm list-marked-secondary">
                                            <li>Wide Variety of Tours</li>
                                            <li>Personalized Matching</li>
                                            <li>Highly Qualified Service</li>
                                            <li>24/7 Support</li>
                                            <li>Handpicked Hotels</li>
                                            <li>Best Price Guarantee</li>
                                        </ul>
                                    </div>
                                    <div class="group-md group-middle"><a class="button button-width-xl-230 button-primary button-pipaluk" href="contact-us.php">Get in touch</a><a class="button button-black-outline button-md" href="">Download presentation</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="owl-carousel owl-classic owl-timeline" data-items="1" data-md-items="2" data-lg-items="3" data-xl-items="4" data-margin="30" data-autoplay="false" data-nav="true" data-dots="true">
                <div class="owl-item">
                    ...
                    <article class="thumbnail thumbnail-mary">
                        <div class="thumbnail-mary-figure"><img src="images/international/france.jpg" alt="" width="420" height="308" />
                        </div>
                        <div class="thumbnail-mary-caption">
                            <a class="icon fl-bigmug-line-zoom60" href="images/international/france.jpg" data-lightgallery="item"><img src="images/international/france.jpg" alt="" width="420" height="308" /></a>
                        </div>
                    </article>
                    <div class="thumbnail-mary-description">
                        <h5 class="thumbnail-mary-project"><a href="international-tour.php">France</a></h5><span class="thumbnail-mary-decor"></span>
                ...
                <div class="owl-item">
                    <!-- Thumbnail Classic-->
                    <article class="thumbnail thumbnail-mary">
                        <div class="thumbnail-mary-figure"><img src="images/international/italy.png" alt="" width="420" height="308" />
                        </div>
                        <div class="thumbnail-mary-caption">
                            <a class="icon fl-bigmug-line-zoom60" href="images/international/italy.png" data-lightgallery="item"><img src="images/international/italy.png" alt="" width="420" height="308" /></a>
                        </div>
                    </article>
                    <div class="thumbnail-mary-description">
                        <h5 class="thumbnail-mary-project"><a href="international-tour.php">Italy</a></h5><span class="thumbnail-mary-decor"></span>
                        <h5 class="thumbnail-mary-time">
                        </h5>
                    </div>
                </div>
                <div class="owl-item">
                    <!-- Thumbnail Classic-->
                    <article class="thumbnail thumbnail-mary">
                        <div class="thumbnail-mary-figure"><img src="images/international/egypt.jpg" alt="" width="420" height="308" />
                        </div>
                        <div class="thumbnail-mary-caption">
                            <a class="icon fl-bigmug-line-zoom60" href="images/international/egypt.jpg" data-lightgallery="item"><img src="images/international/egypt.jpg" alt="" width="420" height="308" /></a>
                        </div>
                    </article>
                    <div class="thumbnail-mary-description">
                        <h5 class="thumbnail-mary-project"><a href="international-tour.php">Egypt</a></h5><span class="thumbnail-mary-decor"></span>
                        <h5 class="thumbnail-mary-time">
                        </h5>
                    </div>
                </div>
                <div class="owl-item">
                    <!-- Thumbnail Classic-->
                    <article class="thumbnail thumbnail-mary">
                        <div class="thumbnail-mary-figure"><img src="images/international/dubai.png" alt="" width="420" height="308" />
                        </div>
                        <div class="thumbnail-mary-caption">
                            <a class="icon fl-bigmug-line-zoom60" href="images/international/dubai.png" data-lightgallery="item"><img src="images/international/dubai.png" alt="" width="420" height="308" /></a>
                        </div>
                    </article>
                    <div class="thumbnail-mary-description">
                        <h5 class="thumbnail-mary-project"><a href="international-tour.php">Dubai</a></h5><span class="thumbnail-mary-decor"></span>
                        <h5 class="thumbnail-mary-time">
                        </h5>
                    </div>
                </div>
                <div class="owl-item">
                    <!-- Thumbnail Classic-->
                    <article class="thumbnail thumbnail-mary">
                        <div class="thumbnail-mary-figure"><img src="images/international/spain.png" alt="" width="420" height="308" />
                        </div>
                        <div class="thumbnail-mary-caption">
                            <a class="icon fl-bigmug-line-zoom60" href="images/international/spain.png" data-lightgallery="item"><img src="images/international/spain.png" alt="" width="420" height="308" /></a>
                        </div>
                    </article>
                    <div class="thumbnail-mary-description">
                        <h5 class="thumbnail-mary-project"><a href="international-tour.php">Spain</a></h5><span class="thumbnail-mary-decor"></span>
                        <h5 class="thumbnail-mary-time">
                        </h5>
                    </div>
                </div>
                <div class="owl-item">
                    <!-- Thumbnail Classic-->
                    <article class="thumbnail thumbnail-mary">
                        <div class="thumbnail-mary-figure"><img src="images/international/africa.jpg" alt="" width="420" height="308" />
                        </div>
                        <div class="thumbnail-mary-caption">
                            <a class="icon fl-bigmug-line-zoom60" href="images/international/africa.jpg" data-lightgallery="item"><img src="images/international/africa.jpg" alt="" width="420" height="308" /></a>
                        </div>
                    </article>
                    <div class="thumbnail-mary-description">
                        <h5 class="thumbnail-mary-project"><a href="international-tour.php">Africa</a></h5><span class="thumbnail-mary-decor"></span>
                        <h5 class="thumbnail-mary-time">
                        </h5>
                    </div>
                </div>
                ...
                <div class="owl-carousel owl-modern" data-items="1" data-stage-padding="15" data-margin="30" data-dots="true" data-animation-in="fadeIn" data-animation-out="fadeOut" data-autoplay="true">
                    ...
                    <article class="quote-lisa">
                        <div class="quote-lisa-body">
                           <img class="img-circles" src="images/uttarakhand tour pack/download.jpg" alt="" width="100" height="100" /></a>
                            ...
                            <h5 class="quote-lisa-cite">Rajesh Goya</h5>
                    ...
                    <article class="quote-lisa">
                        <div class="quote-lisa-body">
                           <img class="img-circles" src="images/uttarakhand tour pack/download1.png" alt="" width="100" height="100" /></a>
                            ...
                            <h5 class="quote-lisa-cite">Piyush Bisht</h5>
                            <p class="quote-lisa-status">Regular Client</p>
                        </div>
                    </article>
                    <!-- Quote Lisa-->
                    <article class="quote-lisa">
                        <div class="quote-lisa-body">
                            ...
                            <h5 class="quote-lisa-cite">Rakhi Rai</h5>
                            <p class="quote-lisa-status">Regular Client</p>
                        </div>
                    </article>
                </div>
        ...
        <section class="section section-fluid bg-default">
            <div class="parallax-container" data-parallax-img="images/international/background.png">
